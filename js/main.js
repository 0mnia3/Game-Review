        ...
        <div class="card shadow-sm" data-id="${game.id}">
          ...
          <div class="card-body">
            ...
            <div class="card-footer d-flex justify-content-between">
              <span class="text-white ">${game.genre.split(" ", 1).join(" ")}</span>
              <span class="text-white ">${game.platform.split(" ", 2).join(" ")}</span>
            </div>
          </div>
        </div>
      `;
      ...
      <div class="row bg-dark left">
        ...
        <div class="col-md-8 right">
          ...
          <ul class="list-unstyled">
            <li class="text-white">Category: <span class=" btn-background rounded-2">${game.genre}</span></li>
            <li class="text-white">Platform: <span class=" btn-background rounded-2">${game.platform}</span></li>
            <li class="text-white">Status: <span class=" btn-background rounded-2">Live</span></li>    
          </ul>
          <p class="text-white w-75">${game.description.split(" ", 150).join(" ")}</p>
          <button type="button" class="btn btn-outline-warning">Show Game</button>
          <div class="d-flex justify-content-end"> 
            <i class="fa-solid fa-xmark fs-2 fw-bold text-muted" id="close"></i>
          </div>
        </div>
      </div>
    `;
